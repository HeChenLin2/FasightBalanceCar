...
static void stm32f4_mpu_get_clock_ms(unsigned long * time)
{
...
#define delay_ms    Systicks_Nms
#define get_ms      stm32f4_mpu_get_clock_ms		//空函数，实际未使用到
